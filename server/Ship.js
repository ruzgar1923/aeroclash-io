const AIRCRAFT_ROSTER = {
  ...
  i16: {
    ...
    cannonDamage: 15,
    cannonCooldown: 0.28,
    secondaryType: 'shkas_burst',
    secondaryCount: 1,
    secondaryCooldown: 3.0,
    secondaryName: 'Twin ShKAS Machine Gun Burst',
    radarRadius: 850,
    weaponLayout: 'nose',
    color: '#00d2ff'
  },
  ...
  p51: {
    ...
    cannonDamage: 22,
    cannonCooldown: 0.22,
    secondaryType: 'six_50cal_salvo',
    secondaryCount: 1,
    secondaryCooldown: 3.5,
    secondaryName: '6x .50 Cal Browning Machine Gun Salvo',
    radarRadius: 1000,
    weaponLayout: 'dual_wing',
    color: '#38ef7d'
  },
  ...
  a10: {
    ...
    cannonDamage: 55,
    cannonCooldown: 0.12,
    secondaryType: 'gau8_gatling_brrrt',
    secondaryCount: 1,
    secondaryCooldown: 4.5,
    secondaryName: 'GAU-8 30mm Avenger Gatling BRRRRT Burst',
    radarRadius: 1600,
    weaponLayout: 'quad_nose',
    color: '#4b6584'
  },
